const { getMenuDetails } = require("./menuDetails");
const { getMenuImage } = require("./menuImage");
const { getRestaurantDetails } = require("./restaurantDetails");
...
const scrap = async (url) => {
  ...
  return {
    ...
    menu: menu,
    menuImageSources: menuImageSources,
  };
};
